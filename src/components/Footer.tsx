                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="lg:col-span-1">
                        <div className="flex items-center mb-4">
                            <div className="w-12 h-12 bg-gradient-to-r from-blue-600 to-green-600 rounded-full flex items-center justify-center mr-3">
                    ...
                    {/* Quick Links */}
                    <div>
                        <h4 className="text-xl font-bold mb-6 text-blue-300">Tautan Cepat</h4>
                    ...
                    {/* Services */}
                    <div>
                        <h4 className="text-xl font-bold mb-6 text-green-300">Layanan Kami</h4>
                        <ul className="space-y-3">
                            <li className="flex items-center group">
                                ...
                                <span className="text-gray-300 group-hover:text-white transition-colors">Sumur Rumah Tangga</span>
                            </li>
                            <li className="flex items-center group">
                                <svg className="w-4 h-4 text-blue-400 mr-3 group-hover:text-green-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                </svg>
                                <span className="text-gray-300 group-hover:text-white transition-colors">Sumur Komersial</span>
                            </li>
                            <li className="flex items-center group">
                                <svg className="w-4 h-4 text-blue-400 mr-3 group-hover:text-green-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                </svg>
                                <span className="text-gray-300 group-hover:text-white transition-colors">Perawatan Sumur</span>
                            </li>
                            <li className="flex items-center group">
                                <svg className="w-4 h-4 text-blue-400 mr-3 group-hover:text-green-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                </svg>
                                <span className="text-gray-300 group-hover:text-white transition-colors">Konsultasi Air</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    {/* Contact Info */}
                    <div>
                        <h4 className="text-xl font-bold mb-6 text-blue-300">Info Kontak</h4>
                        <div className="space-y-4">
                            <div className="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-white">info@sumurborpro.com</p>
                                </div>
                            </div>
                            <div className="flex items-start">
                                <div className="w-8 h-8 bg-gradient-to-r from-blue-600 to-green-600 rounded-full flex items-center justify-center mr-3 mt-1">
                                ...
                                <div>
                                    <p className="text-gray-300 font-medium">Telepon</p>
                            ...
                            <div className="flex items-start">
                                ...
                                <div>
                                    <p className="text-gray-300 font-medium">Alamat</p>
